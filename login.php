...
$ret= mysqli_query($con,"SELECT id,member_name FROM users WHERE email='$useremail' and password='$dec_password'");
$num=mysqli_fetch_array($ret);
if($num>0)
{

$_SESSION['id']=$num['id'];
$_SESSION['name']=$num['member_name'];
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="signup.php">Need an account? Sign up!</a></div>
                                          <div class="small"><a href="../index.html">Back to Home</a></div>
                                              <div class="small"><a href="admin/index.php">Admin</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
