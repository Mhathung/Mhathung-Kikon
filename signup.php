...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into users(member_name,email,password,contactno) values('$member_name','$email','$password','$contact')");
...
<input class="form-control" id="member_name" name="member_name" type="text" placeholder="Enter your name" required />
